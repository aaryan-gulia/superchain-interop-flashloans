...
contract UniswapDummyContractTest is Test{
    ...
    vm.deal(address(this), 1000 ether); // Fund test contract with ETH
    console.log("Test Contract ETH Balance Before:", address(this).balance);
    ...
    // Buy ETH using TUSD
    uniswapDummyContract.buyEth(payable(address(this)), tusdBalance);
